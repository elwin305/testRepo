...
import hw7.ui.UI;
import hw7.ui.UIMenu;
import hw7.ui.UIMenuAction;
import hw7.ui.UIMenuBuilder;
import hw7.ui.UIError;
import hw7.ui.UIForm;
import hw7.ui.UIFormTest;
import hw7.ui.UIFormBuilder;
import hw7.data.Data;
import hw7.data.Inventory;
import hw7.data.Video;
import hw7.data.Record;
import hw7.command.Command;
      ...
      new UIMenuAction() {
        public void run() {
          // TODO
        	...
        	Iterator<Record> topVideos = _inventory.iterator((r1,r2) -> r2.numRentals() - r1.numRentals());
        	...
        	while(topVideos.hasNext() && emptySlot > 0) {
        		
        	    Record r = topVideos.next();
        	    
        	    b.append("top");
        	    b.append(11-emptySlot);
        	    b.append(": ");
        	    b.append(r.video().title());
        	    b.append("\n");
